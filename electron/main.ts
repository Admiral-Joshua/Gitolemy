...
import { GitAuthor } from "../src/app/git.service/datatypes/GitAuthor"
...
app.on('ready', () => {
    ...
    ipcMain.on('getAuthor', (e) => {
        return new GitAuthor("Joshua Richardson-Noyes", "admiraljrn@outlook.com");
    });
